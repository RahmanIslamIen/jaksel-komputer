            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/data-produk" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="/data-costumer" class="nav-link">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">semua data produk yang ada</h3>
                                </div>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                        ...
                                        <tbody>
                                            @foreach ($produk as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->harga }}</td>
                                                    <td>
                                                        <a href="{{ url('edit-produk/' . $item->id) }}"
